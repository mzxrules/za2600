...
RESMP0  equ     $28     ;Reset Missle 0 to Player 0
RESMP1  equ     $29     ;Reset Missle 1 to Player 1
...
SWACNT  equ     $281    ;Part A data direction register (DDR)
SWCHB   equ     $282    ;Port B data (console switches) 
SWBCNT  equ     $283    ;Port B data direction register (DDR)
