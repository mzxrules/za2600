...
GAME_COLOR_TABLE = {
    ...
    "COLOR_DARK_GRAY":      (0x02,0x06),
    "COLOR_GRAY":           (0x06,0x0C),
    "COLOR_WHITE":          (0x0E,0x0E),
    ...
    "COLOR_PLAYER_01":      (0x08,0x0C),
    "COLOR_PLAYER_02":      (0x46,0x64),

    "COLOR_PATH":           (0x3C,0x4C),
    "COLOR_GREEN_ROCK":     (0xD0,0x52),
    "COLOR_RED_ROCK":       (0x42,0x64),
    "COLOR_CHOCOLATE":      (0xF0,0x22),
    "COLOR_LIGHT_WATER":    (0xAE,0x9E),

    "COLOR_DARK_BLUE":      (0x90,0xC0),
    "COLOR_LIGHT_BLUE":     (0x86,0xD6), # World
